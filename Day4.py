...
def convert_string_to_set(string):
    ...
    string = string.split('-')
    intervall_set1 = {i for i in range(int(string[0]), int(string[1]) + 1)}
    intervall_set2 = {i for i in range(int(string[2]), int(string[3]) + 1)}
    return intervall_set1, intervall_set2
