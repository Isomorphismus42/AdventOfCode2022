...
CrZsJsPPZsGzwwsLwLmpwMDw
    ...
    compartments only share item type v. The fifth rucksack's compartments only share item type t. The sixth
    rucksack's compartments only share item type s.
...
item_priorities = {string.ascii_letters[i - 1]: i for i in range(1, 53)}


def char_in_strings(string1, string2, string3=string.ascii_letters):
    for char in string1:
...
def part1():
    ...
    with open('inputs/input_day3', 'r') as file:
        for line in file:
            ...
            priorities_sum += item_priorities[char_in_strings(compartment1, compartment2)]
...
def part2():
    ...
    with open('inputs/input_day3', 'r') as file:
        ...
        while rucksack1 != '':
            ...
            rucksack3 = file.readline()
            badge = char_in_strings(rucksack1, rucksack2, rucksack3)
            priorities_sum += item_priorities[badge]
            rucksack1 = file.readline()
    return priorities_sum
