    ...
    with open('input_day1', 'r') as file:
        ...
        for line in file:
            if line == '\n':
                ...
                elif current_sum > second_most_calories:
                    third_most_calories = second_most_calories
                    second_most_calories = current_sum
                elif current_sum > third_most_calories:
                    third_most_calories = current_sum
                current_sum = 0
            else:
                current_sum += int(line)
    combined = most_calories + second_most_calories + third_most_calories
    return most_calories, second_most_calories, third_most_calories, combined
